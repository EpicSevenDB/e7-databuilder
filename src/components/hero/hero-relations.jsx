...
class HeroRelations extends Component {
    ...
    handleDelete = i => {
        const relations = [...this.state.relations.slice(0, i), ...this.state.relations.slice(i + 1)];
        this.setState({ relations });
    };
                    ...
                    <Form key={i} inline>
                        <FormGroup className="inline-wrapper">
                            <Input
                                ...
                                bsSize="sm"
                                value={relation.hero}
                                onChange={e => this.handleChange("hero", this.friendlyString(e.currentTarget.value), i)}
                                onBlur={this.onBlur}
                            />
                            <Input
                                type="select"
                                ...
                                onChange={e => this.handleChange("relationType", e.currentTarget.value, i)}
                                onBlur={this.onBlur}
                            >
