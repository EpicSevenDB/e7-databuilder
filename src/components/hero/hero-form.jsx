...
import { FormGroup, Card, CardBody, CardHeader, Button, Collapse } from "reactstrap";
            ...
            <React.Fragment>
                ...
                <Card>
                    ...
                    <Collapse isOpen={!collapse[4]}>
                        <CardBody>
                            <FormGroup row>
                                <HeroSpecialtySkills specialtySkill={hero.specialtySkill} onChange={onChange} />
                            </FormGroup>
                        </CardBody>
                    </Collapse>
                </Card>
                        ...
                        <CardBody>
                            <FormGroup row>
                                <HeroMemoryImprint
                                    ...
                                    defaultMemoryImprintFormation={defaults.hero.memoryImprintFormation}
