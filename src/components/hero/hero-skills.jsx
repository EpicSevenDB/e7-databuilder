...
import { Col, TabContent, TabPane, Nav, NavItem, NavLink, FormGroup, CustomInput } from "reactstrap";
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md="3" className="empty-label">
                                        <CustomInput
                                            ...
                                            onChange={e =>
                                                this.handleChange(e.currentTarget.name, e.currentTarget.checked, i)
                                            }
                                        />
                                    </Col>
                                    <Col md="3" className="empty-label">
